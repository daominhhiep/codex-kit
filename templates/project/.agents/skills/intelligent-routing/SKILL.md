...
description: Use only when deciding which specialist skills or subagents should handle a task. Do not use as a default skill for ordinary implementation work.
---
